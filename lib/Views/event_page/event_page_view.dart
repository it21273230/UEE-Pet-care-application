...
class _EventPageViewState extends State<EventPageView> {
  ...
  Widget build(BuildContext context) {
    ...
    String image = ''; String  CurrentUserName = ''; String  CurrentUserToken = '';
    ...
    Future<void> sendRequest(String organizerName) async {
      ...
      if (organizerName.isNotEmpty) {
        ...
        await FirebaseFirestore.instance.collection('requests').add({
          ...
          'requesterUid': CurrentUserToken,
          'requestername': CurrentUserName,// Get the user's name
          'requester_email' :FirebaseAuth.instance.currentUser!.email,
          'eventId': widget.eventData!.id, // Replace with the actual event ID
          'status': 'pending',
        });

        Get.snackbar('Request sent to ',organizerName ,
                ...
                children: [
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        if (widget.user != null) {
                          String organizerName = '${widget.user.get('first')} ${widget.user.get('last')}';
