                ...
                textField(
                    ...
                    validator: (String input) {
                      if (experienceController.text.isEmpty) {
                        Get.snackbar('Warning', 'Experience is required.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                Obx(()=> authController!.isProfileInformationLoading.value? Center(child: CircularProgressIndicator(),) :Container(
                  ...
                  child: elevatedButton(
                    ...
                    onpress: () async{
                      ...
                      authController!.uploadProfileDataTrainer(imageUrl, firstNameController.text.trim(), lastNameController.text.trim(),CostController.text.trim(),CertificateController.text.trim(),experienceController.text.trim(), mobileNumberController.text.trim(), dob.text.trim(), selectedRadio ==0 ? "Male": "Female");
